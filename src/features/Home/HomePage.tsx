...
type AppDialogType = typeof AppDialogType[keyof typeof AppDialogType];
...
const software : Array<AppData> = [
  {
    title: 'Pure Art AI',
    url: 'https://play.google.com/store/apps/details?id=com.ampsoft.imagegenerator',
    description: 'Your ideas belong to you. Unlike other AI art creators, our app uses local, on-device generation. This means your descriptions and images never leave your phone.',
    icon: PureArtIcon,
    features: [
      {
        title: 'Advanced AI-Powered Generation',
        description: 'Leverage the power of diffusion to turn natural language into high-quality visuals. Watch your thoughts come to life on a digital canvas in seconds.',
      },
      {
        title: 'Personal Art Portfolio',
        description: 'Keep a private gallery of your favorite generations. Track your creative journey and revisit past ideas in an organized, local vault.',
      },
      {
        title: 'Infinite Styles',
        description: 'From photo-realistic portraits and raster renders, to anime art and abstract oil paintings, the possibilities are endless.',
      },
      {
        title: 'High-Resolution Exports',
        description: 'Save your masterpieces directly to your device to use as wallpapers, social media posts, or personal projects.',
      },
    ],
    disclaimers: [
      'This app is intended for personal reflection, creative exploration, and entertainment.',
      'Images generated by this AI are not currently subject to copyright under existing laws.',
      'Users maintain exclusive local rights to all images generated through the app.',
    ],
    privacyPath: '#/privacy/pureart'
  },
  {
    title: 'Aura Dream AI',
...
function HomePage() {
  ...
  const [dialogApp, setDialogApp] = useState<AppData>();
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
              Explore our full range of local-first tools. Each app is built from the ground up to
              provide powerful AI insights while keeping your data 100% private.
            </p>
          </motion.div>
                ...
                <CardContent className="space-y-3">
                  <div className="flex flex-col md:grid md:grid-cols-2 gap-3">
                    <Button
                      variant="secondary"
                      type="button"
                      onClick={() => handleDialogOpen(app, AppDialogType.Features)}
                    ...
                    <Button
                      variant="secondary"
                      type="button"
                      onClick={() => handleDialogOpen(app, AppDialogType.Disclaimers)}
                      className="cursor-pointer"
                    >
      ...
      <Dialog open={isDialogOpen} onOpenChange={handleDialogClose}>
        ...
        >
          ...
          {dialogType === AppDialogType.Features && (
            <div className="pb-4">
              <h2 className="text-md text-text-primary mb-2">
                Key Features
              </h2>
              <ul className="space-y-4">
              {dialogApp?.features.map((feature, index) => (
          ...
          {dialogType === AppDialogType.Disclaimers && (
            <div className="pb-8 mt-6">
              ...
              {dialogApp?.disclaimers.map((disclaimer, index) => (
